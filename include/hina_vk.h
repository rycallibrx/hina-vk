 ...
 *   and similar functions write descriptors immediately. In debug builds, they assert if a referenced
 *   resource upload is still pending.
 *
 ...
 * This enum is generated by scripts/gen_formats.py from vk.xml.
 * Legacy values (1..112) are frozen for .hina_mod serialization compatibility.
 * Run `python scripts/gen_formats.py` after updating the Vulkan SDK.
 */
/* HINA_FORMAT_GEN_BEGIN -- auto-generated by scripts/gen_formats.py, do not edit */

/*
 * X-macro table of all Vulkan formats.
 * Legacy values 1..112 are frozen for .hina_mod serialization.
 * New values 113+ appended from vk.xml.
 *
 * X(name, pixel_size, block_w, block_h, block_bytes, flags)
 *   flags: 1=integer, 2=depth, 4=stencil
 */
#define HINA_FORMAT_TABLE(X) \
  X(R8_UNORM,                                         1,  0, 0, 0, 0) \
  X(R8_SNORM,                                         1,  0, 0, 0, 0) \
  X(R8_UINT,                                          1,  0, 0, 0, 1) \
  X(R8_SINT,                                          1,  0, 0, 0, 1) \
  X(R8G8_UNORM,                                       2,  0, 0, 0, 0) \
  X(R8G8_SNORM,                                       2,  0, 0, 0, 0) \
  X(R8G8_UINT,                                        2,  0, 0, 0, 1) \
  X(R8G8_SINT,                                        2,  0, 0, 0, 1) \
  X(R8G8B8_UNORM,                                     3,  0, 0, 0, 0) \
  X(R8G8B8_SNORM,                                     3,  0, 0, 0, 0) \
  X(R8G8B8_UINT,                                      3,  0, 0, 0, 1) \
  X(R8G8B8_SINT,                                      3,  0, 0, 0, 1) \
  X(R8G8B8A8_UNORM,                                   4,  0, 0, 0, 0) \
  X(R8G8B8A8_SNORM,                                   4,  0, 0, 0, 0) \
  X(R8G8B8A8_UINT,                                    4,  0, 0, 0, 1) \
  X(R8G8B8A8_SINT,                                    4,  0, 0, 0, 1) \
  X(R8G8B8A8_SRGB,                                    4,  0, 0, 0, 0) \
  X(B8G8R8A8_UNORM,                                   4,  0, 0, 0, 0) \
  X(B8G8R8A8_SRGB,                                    4,  0, 0, 0, 0) \
  X(R16_UNORM,                                        2,  0, 0, 0, 0) \
  X(R16_SNORM,                                        2,  0, 0, 0, 0) \
  X(R16_UINT,                                         2,  0, 0, 0, 1) \
  X(R16_SINT,                                         2,  0, 0, 0, 1) \
  X(R16_SFLOAT,                                       2,  0, 0, 0, 0) \
  X(R16G16_UNORM,                                     4,  0, 0, 0, 0) \
  X(R16G16_SNORM,                                     4,  0, 0, 0, 0) \
  X(R16G16_UINT,                                      4,  0, 0, 0, 1) \
  X(R16G16_SINT,                                      4,  0, 0, 0, 1) \
  X(R16G16_SFLOAT,                                    4,  0, 0, 0, 0) \
  X(R16G16B16_UNORM,                                  6,  0, 0, 0, 0) \
  X(R16G16B16_SNORM,                                  6,  0, 0, 0, 0) \
  X(R16G16B16_UINT,                                   6,  0, 0, 0, 1) \
  X(R16G16B16_SINT,                                   6,  0, 0, 0, 1) \
  X(R16G16B16_SFLOAT,                                 6,  0, 0, 0, 0) \
  X(R16G16B16A16_UNORM,                               8,  0, 0, 0, 0) \
  X(R16G16B16A16_SNORM,                               8,  0, 0, 0, 0) \
  X(R16G16B16A16_UINT,                                8,  0, 0, 0, 1) \
  X(R16G16B16A16_SINT,                                8,  0, 0, 0, 1) \
  X(R16G16B16A16_SFLOAT,                              8,  0, 0, 0, 0) \
  X(R32_UINT,                                         4,  0, 0, 0, 1) \
  X(R32_SINT,                                         4,  0, 0, 0, 1) \
  X(R32_SFLOAT,                                       4,  0, 0, 0, 0) \
  X(R32G32_UINT,                                      8,  0, 0, 0, 1) \
  X(R32G32_SINT,                                      8,  0, 0, 0, 1) \
  X(R32G32_SFLOAT,                                    8,  0, 0, 0, 0) \
  X(R32G32B32_UINT,                                  12,  0, 0, 0, 1) \
  X(R32G32B32_SINT,                                  12,  0, 0, 0, 1) \
  X(R32G32B32_SFLOAT,                                12,  0, 0, 0, 0) \
  X(R32G32B32A32_UINT,                               16,  0, 0, 0, 1) \
  X(R32G32B32A32_SINT,                               16,  0, 0, 0, 1) \
  X(R32G32B32A32_SFLOAT,                             16,  0, 0, 0, 0) \
  X(D16_UNORM,                                        2,  0, 0, 0, 2) \
  X(X8_D24_UNORM_PACK32,                              4,  0, 0, 0, 2) \
  X(D32_SFLOAT,                                       4,  0, 0, 0, 2) \
  X(S8_UINT,                                          1,  0, 0, 0, 4) \
  X(D16_UNORM_S8_UINT,                                3,  0, 0, 0, 6) \
  X(D24_UNORM_S8_UINT,                                4,  0, 0, 0, 6) \
  X(D32_SFLOAT_S8_UINT,                               5,  0, 0, 0, 6) \
  X(BC1_RGB_UNORM_BLOCK,                              0,  4, 4, 8, 0) \
  X(BC1_RGB_SRGB_BLOCK,                               0,  4, 4, 8, 0) \
  X(BC1_RGBA_UNORM_BLOCK,                             0,  4, 4, 8, 0) \
  X(BC1_RGBA_SRGB_BLOCK,                              0,  4, 4, 8, 0) \
  X(BC2_UNORM_BLOCK,                                  0,  4, 4,16, 0) \
  X(BC2_SRGB_BLOCK,                                   0,  4, 4,16, 0) \
  X(BC3_UNORM_BLOCK,                                  0,  4, 4,16, 0) \
  X(BC3_SRGB_BLOCK,                                   0,  4, 4,16, 0) \
  X(BC4_UNORM_BLOCK,                                  0,  4, 4, 8, 0) \
  X(BC4_SNORM_BLOCK,                                  0,  4, 4, 8, 0) \
  X(BC5_UNORM_BLOCK,                                  0,  4, 4,16, 0) \
  X(BC5_SNORM_BLOCK,                                  0,  4, 4,16, 0) \
  X(BC6H_UFLOAT_BLOCK,                                0,  4, 4,16, 0) \
  X(BC6H_SFLOAT_BLOCK,                                0,  4, 4,16, 0) \
  X(BC7_UNORM_BLOCK,                                  0,  4, 4,16, 0) \
  X(BC7_SRGB_BLOCK,                                   0,  4, 4,16, 0) \
  X(ETC2_R8G8B8_UNORM_BLOCK,                          0,  4, 4, 8, 0) \
  X(ETC2_R8G8B8_SRGB_BLOCK,                           0,  4, 4, 8, 0) \
  X(ETC2_R8G8B8A1_UNORM_BLOCK,                        0,  4, 4, 8, 0) \
  X(ETC2_R8G8B8A1_SRGB_BLOCK,                         0,  4, 4, 8, 0) \
  X(ETC2_R8G8B8A8_UNORM_BLOCK,                        0,  4, 4,16, 0) \
  X(ETC2_R8G8B8A8_SRGB_BLOCK,                         0,  4, 4,16, 0) \
  X(EAC_R11_UNORM_BLOCK,                              0,  4, 4, 8, 0) \
  X(EAC_R11_SNORM_BLOCK,                              0,  4, 4, 8, 0) \
  X(EAC_R11G11_UNORM_BLOCK,                           0,  4, 4,16, 0) \
  X(EAC_R11G11_SNORM_BLOCK,                           0,  4, 4,16, 0) \
  X(ASTC_4x4_UNORM_BLOCK,                             0,  4, 4,16, 0) \
  X(ASTC_4x4_SRGB_BLOCK,                              0,  4, 4,16, 0) \
  X(ASTC_5x4_UNORM_BLOCK,                             0,  5, 4,16, 0) \
  X(ASTC_5x4_SRGB_BLOCK,                              0,  5, 4,16, 0) \
  X(ASTC_5x5_UNORM_BLOCK,                             0,  5, 5,16, 0) \
  X(ASTC_5x5_SRGB_BLOCK,                              0,  5, 5,16, 0) \
  X(ASTC_6x5_UNORM_BLOCK,                             0,  6, 5,16, 0) \
  X(ASTC_6x5_SRGB_BLOCK,                              0,  6, 5,16, 0) \
  X(ASTC_6x6_UNORM_BLOCK,                             0,  6, 6,16, 0) \
  X(ASTC_6x6_SRGB_BLOCK,                              0,  6, 6,16, 0) \
  X(ASTC_8x5_UNORM_BLOCK,                             0,  8, 5,16, 0) \
  X(ASTC_8x5_SRGB_BLOCK,                              0,  8, 5,16, 0) \
  X(ASTC_8x6_UNORM_BLOCK,                             0,  8, 6,16, 0) \
  X(ASTC_8x6_SRGB_BLOCK,                              0,  8, 6,16, 0) \
  X(ASTC_8x8_UNORM_BLOCK,                             0,  8, 8,16, 0) \
  X(ASTC_8x8_SRGB_BLOCK,                              0,  8, 8,16, 0) \
  X(ASTC_10x5_UNORM_BLOCK,                            0, 10, 5,16, 0) \
  X(ASTC_10x5_SRGB_BLOCK,                             0, 10, 5,16, 0) \
  X(ASTC_10x6_UNORM_BLOCK,                            0, 10, 6,16, 0) \
  X(ASTC_10x6_SRGB_BLOCK,                             0, 10, 6,16, 0) \
  X(ASTC_10x8_UNORM_BLOCK,                            0, 10, 8,16, 0) \
  X(ASTC_10x8_SRGB_BLOCK,                             0, 10, 8,16, 0) \
  X(ASTC_10x10_UNORM_BLOCK,                           0, 10,10,16, 0) \
  X(ASTC_10x10_SRGB_BLOCK,                            0, 10,10,16, 0) \
  X(ASTC_12x10_UNORM_BLOCK,                           0, 12,10,16, 0) \
  X(ASTC_12x10_SRGB_BLOCK,                            0, 12,10,16, 0) \
  X(ASTC_12x12_UNORM_BLOCK,                           0, 12,12,16, 0) \
  X(ASTC_12x12_SRGB_BLOCK,                            0, 12,12,16, 0) \
  /* ---- New formats from vk.xml (values 113+) ---- */ \
  X(R4G4_UNORM_PACK8,                                 1,  0, 0, 0, 0) \
  X(R4G4B4A4_UNORM_PACK16,                            2,  0, 0, 0, 0) \
  X(B4G4R4A4_UNORM_PACK16,                            2,  0, 0, 0, 0) \
  X(R5G6B5_UNORM_PACK16,                              2,  0, 0, 0, 0) \
  X(B5G6R5_UNORM_PACK16,                              2,  0, 0, 0, 0) \
  X(R5G5B5A1_UNORM_PACK16,                            2,  0, 0, 0, 0) \
  X(B5G5R5A1_UNORM_PACK16,                            2,  0, 0, 0, 0) \
  X(A1R5G5B5_UNORM_PACK16,                            2,  0, 0, 0, 0) \
  X(A1B5G5R5_UNORM_PACK16,                            2,  0, 0, 0, 0) \
  X(A8_UNORM,                                         1,  0, 0, 0, 0) \
  X(R8_USCALED,                                       1,  0, 0, 0, 0) \
  X(R8_SSCALED,                                       1,  0, 0, 0, 0) \
  X(R8_SRGB,                                          1,  0, 0, 0, 0) \
  X(R8G8_USCALED,                                     2,  0, 0, 0, 0) \
  X(R8G8_SSCALED,                                     2,  0, 0, 0, 0) \
  X(R8G8_SRGB,                                        2,  0, 0, 0, 0) \
  X(R8G8B8_USCALED,                                   3,  0, 0, 0, 0) \
  X(R8G8B8_SSCALED,                                   3,  0, 0, 0, 0) \
  X(R8G8B8_SRGB,                                      3,  0, 0, 0, 0) \
  X(B8G8R8_UNORM,                                     3,  0, 0, 0, 0) \
  X(B8G8R8_SNORM,                                     3,  0, 0, 0, 0) \
  X(B8G8R8_USCALED,                                   3,  0, 0, 0, 0) \
  X(B8G8R8_SSCALED,                                   3,  0, 0, 0, 0) \
  X(B8G8R8_UINT,                                      3,  0, 0, 0, 1) \
  X(B8G8R8_SINT,                                      3,  0, 0, 0, 1) \
  X(B8G8R8_SRGB,                                      3,  0, 0, 0, 0) \
  X(R8G8B8A8_USCALED,                                 4,  0, 0, 0, 0) \
  X(R8G8B8A8_SSCALED,                                 4,  0, 0, 0, 0) \
  X(B8G8R8A8_SNORM,                                   4,  0, 0, 0, 0) \
  X(B8G8R8A8_USCALED,                                 4,  0, 0, 0, 0) \
  X(B8G8R8A8_SSCALED,                                 4,  0, 0, 0, 0) \
  X(B8G8R8A8_UINT,                                    4,  0, 0, 0, 1) \
  X(B8G8R8A8_SINT,                                    4,  0, 0, 0, 1) \
  X(A8B8G8R8_UNORM_PACK32,                            4,  0, 0, 0, 0) \
  X(A8B8G8R8_SNORM_PACK32,                            4,  0, 0, 0, 0) \
  X(A8B8G8R8_USCALED_PACK32,                          4,  0, 0, 0, 0) \
  X(A8B8G8R8_SSCALED_PACK32,                          4,  0, 0, 0, 0) \
  X(A8B8G8R8_UINT_PACK32,                             4,  0, 0, 0, 1) \
  X(A8B8G8R8_SINT_PACK32,                             4,  0, 0, 0, 1) \
  X(A8B8G8R8_SRGB_PACK32,                             4,  0, 0, 0, 0) \
  X(A2R10G10B10_UNORM_PACK32,                         4,  0, 0, 0, 0) \
  X(A2R10G10B10_SNORM_PACK32,                         4,  0, 0, 0, 0) \
  X(A2R10G10B10_USCALED_PACK32,                       4,  0, 0, 0, 0) \
  X(A2R10G10B10_SSCALED_PACK32,                       4,  0, 0, 0, 0) \
  X(A2R10G10B10_UINT_PACK32,                          4,  0, 0, 0, 1) \
  X(A2R10G10B10_SINT_PACK32,                          4,  0, 0, 0, 1) \
  X(A2B10G10R10_UNORM_PACK32,                         4,  0, 0, 0, 0) \
  X(A2B10G10R10_SNORM_PACK32,                         4,  0, 0, 0, 0) \
  X(A2B10G10R10_USCALED_PACK32,                       4,  0, 0, 0, 0) \
  X(A2B10G10R10_SSCALED_PACK32,                       4,  0, 0, 0, 0) \
  X(A2B10G10R10_UINT_PACK32,                          4,  0, 0, 0, 1) \
  X(A2B10G10R10_SINT_PACK32,                          4,  0, 0, 0, 1) \
  X(R16_USCALED,                                      2,  0, 0, 0, 0) \
  X(R16_SSCALED,                                      2,  0, 0, 0, 0) \
  X(R16G16_USCALED,                                   4,  0, 0, 0, 0) \
  X(R16G16_SSCALED,                                   4,  0, 0, 0, 0) \
  X(R16G16B16_USCALED,                                6,  0, 0, 0, 0) \
  X(R16G16B16_SSCALED,                                6,  0, 0, 0, 0) \
  X(R16G16B16A16_USCALED,                             8,  0, 0, 0, 0) \
  X(R16G16B16A16_SSCALED,                             8,  0, 0, 0, 0) \
  X(R64_UINT,                                         8,  0, 0, 0, 1) \
  X(R64_SINT,                                         8,  0, 0, 0, 1) \
  X(R64_SFLOAT,                                       8,  0, 0, 0, 0) \
  X(R64G64_UINT,                                     16,  0, 0, 0, 1) \
  X(R64G64_SINT,                                     16,  0, 0, 0, 1) \
  X(R64G64_SFLOAT,                                   16,  0, 0, 0, 0) \
  X(R64G64B64_UINT,                                  24,  0, 0, 0, 1) \
  X(R64G64B64_SINT,                                  24,  0, 0, 0, 1) \
  X(R64G64B64_SFLOAT,                                24,  0, 0, 0, 0) \
  X(R64G64B64A64_UINT,                               32,  0, 0, 0, 1) \
  X(R64G64B64A64_SINT,                               32,  0, 0, 0, 1) \
  X(R64G64B64A64_SFLOAT,                             32,  0, 0, 0, 0) \
  X(B10G11R11_UFLOAT_PACK32,                          4,  0, 0, 0, 0) \
  X(E5B9G9R9_UFLOAT_PACK32,                           4,  0, 0, 0, 0) \
  X(G8B8G8R8_422_UNORM,                               0,  0, 0, 0, 0) \
  X(B8G8R8G8_422_UNORM,                               0,  0, 0, 0, 0) \
  X(G8_B8_R8_3PLANE_420_UNORM,                        0,  0, 0, 0, 0) \
  X(G8_B8R8_2PLANE_420_UNORM,                         0,  0, 0, 0, 0) \
  X(G8_B8_R8_3PLANE_422_UNORM,                        0,  0, 0, 0, 0) \
  X(G8_B8R8_2PLANE_422_UNORM,                         0,  0, 0, 0, 0) \
  X(G8_B8_R8_3PLANE_444_UNORM,                        0,  0, 0, 0, 0) \
  X(R10X6_UNORM_PACK16,                               2,  0, 0, 0, 0) \
  X(R10X6G10X6_UNORM_2PACK16,                         4,  0, 0, 0, 0) \
  X(R10X6G10X6B10X6A10X6_UNORM_4PACK16,               0,  0, 0, 0, 0) \
  X(G10X6B10X6G10X6R10X6_422_UNORM_4PACK16,           0,  0, 0, 0, 0) \
  X(B10X6G10X6R10X6G10X6_422_UNORM_4PACK16,           0,  0, 0, 0, 0) \
  X(G10X6_B10X6_R10X6_3PLANE_420_UNORM_3PACK16,       0,  0, 0, 0, 0) \
  X(G10X6_B10X6R10X6_2PLANE_420_UNORM_3PACK16,        0,  0, 0, 0, 0) \
  X(G10X6_B10X6_R10X6_3PLANE_422_UNORM_3PACK16,       0,  0, 0, 0, 0) \
  X(G10X6_B10X6R10X6_2PLANE_422_UNORM_3PACK16,        0,  0, 0, 0, 0) \
  X(G10X6_B10X6_R10X6_3PLANE_444_UNORM_3PACK16,       0,  0, 0, 0, 0) \
  X(R12X4_UNORM_PACK16,                               2,  0, 0, 0, 0) \
  X(R12X4G12X4_UNORM_2PACK16,                         4,  0, 0, 0, 0) \
  X(R12X4G12X4B12X4A12X4_UNORM_4PACK16,               0,  0, 0, 0, 0) \
  X(G12X4B12X4G12X4R12X4_422_UNORM_4PACK16,           0,  0, 0, 0, 0) \
  X(B12X4G12X4R12X4G12X4_422_UNORM_4PACK16,           0,  0, 0, 0, 0) \
  X(G12X4_B12X4_R12X4_3PLANE_420_UNORM_3PACK16,       0,  0, 0, 0, 0) \
  X(G12X4_B12X4R12X4_2PLANE_420_UNORM_3PACK16,        0,  0, 0, 0, 0) \
  X(G12X4_B12X4_R12X4_3PLANE_422_UNORM_3PACK16,       0,  0, 0, 0, 0) \
  X(G12X4_B12X4R12X4_2PLANE_422_UNORM_3PACK16,        0,  0, 0, 0, 0) \
  X(G12X4_B12X4_R12X4_3PLANE_444_UNORM_3PACK16,       0,  0, 0, 0, 0) \
  X(G16B16G16R16_422_UNORM,                           0,  0, 0, 0, 0) \
  X(B16G16R16G16_422_UNORM,                           0,  0, 0, 0, 0) \
  X(G16_B16_R16_3PLANE_420_UNORM,                     0,  0, 0, 0, 0) \
  X(G16_B16R16_2PLANE_420_UNORM,                      0,  0, 0, 0, 0) \
  X(G16_B16_R16_3PLANE_422_UNORM,                     0,  0, 0, 0, 0) \
  X(G16_B16R16_2PLANE_422_UNORM,                      0,  0, 0, 0, 0) \
  X(G16_B16_R16_3PLANE_444_UNORM,                     0,  0, 0, 0, 0) \
  X(PVRTC1_2BPP_UNORM_BLOCK_IMG,                      0,  8, 4, 8, 0) \
  X(PVRTC1_4BPP_UNORM_BLOCK_IMG,                      0,  4, 4, 8, 0) \
  X(PVRTC2_2BPP_UNORM_BLOCK_IMG,                      0,  8, 4, 8, 0) \
  X(PVRTC2_4BPP_UNORM_BLOCK_IMG,                      0,  4, 4, 8, 0) \
  X(PVRTC1_2BPP_SRGB_BLOCK_IMG,                       0,  8, 4, 8, 0) \
  X(PVRTC1_4BPP_SRGB_BLOCK_IMG,                       0,  4, 4, 8, 0) \
  X(PVRTC2_2BPP_SRGB_BLOCK_IMG,                       0,  8, 4, 8, 0) \
  X(PVRTC2_4BPP_SRGB_BLOCK_IMG,                       0,  4, 4, 8, 0) \
  X(ASTC_4x4_SFLOAT_BLOCK,                            0,  4, 4,16, 0) \
  X(ASTC_5x4_SFLOAT_BLOCK,                            0,  5, 4,16, 0) \
  X(ASTC_5x5_SFLOAT_BLOCK,                            0,  5, 5,16, 0) \
  X(ASTC_6x5_SFLOAT_BLOCK,                            0,  6, 5,16, 0) \
  X(ASTC_6x6_SFLOAT_BLOCK,                            0,  6, 6,16, 0) \
  X(ASTC_8x5_SFLOAT_BLOCK,                            0,  8, 5,16, 0) \
  X(ASTC_8x6_SFLOAT_BLOCK,                            0,  8, 6,16, 0) \
  X(ASTC_8x8_SFLOAT_BLOCK,                            0,  8, 8,16, 0) \
  X(ASTC_10x5_SFLOAT_BLOCK,                           0, 10, 5,16, 0) \
  X(ASTC_10x6_SFLOAT_BLOCK,                           0, 10, 6,16, 0) \
  X(ASTC_10x8_SFLOAT_BLOCK,                           0, 10, 8,16, 0) \
  X(ASTC_10x10_SFLOAT_BLOCK,                          0, 10,10,16, 0) \
  X(ASTC_12x10_SFLOAT_BLOCK,                          0, 12,10,16, 0) \
  X(ASTC_12x12_SFLOAT_BLOCK,                          0, 12,12,16, 0) \
  X(G8_B8R8_2PLANE_444_UNORM,                         0,  0, 0, 0, 0) \
  X(G10X6_B10X6R10X6_2PLANE_444_UNORM_3PACK16,        0,  0, 0, 0, 0) \
  X(G12X4_B12X4R12X4_2PLANE_444_UNORM_3PACK16,        0,  0, 0, 0, 0) \
  X(G16_B16R16_2PLANE_444_UNORM,                      0,  0, 0, 0, 0) \
  X(A4R4G4B4_UNORM_PACK16,                            2,  0, 0, 0, 0) \
  X(A4B4G4R4_UNORM_PACK16,                            2,  0, 0, 0, 0) \
  X(R16G16_SFIXED5_NV,                                4,  0, 0, 0, 0) \
  X(R10X6_UINT_PACK16_ARM,                            2,  0, 0, 0, 1) \
  X(R10X6G10X6_UINT_2PACK16_ARM,                      4,  0, 0, 0, 1) \
  X(R10X6G10X6B10X6A10X6_UINT_4PACK16_ARM,            8,  0, 0, 0, 1) \
  X(R12X4_UINT_PACK16_ARM,                            2,  0, 0, 0, 1) \
  X(R12X4G12X4_UINT_2PACK16_ARM,                      4,  0, 0, 0, 1) \
  X(R12X4G12X4B12X4A12X4_UINT_4PACK16_ARM,            8,  0, 0, 0, 1) \
  X(R14X2_UINT_PACK16_ARM,                            2,  0, 0, 0, 1) \
  X(R14X2G14X2_UINT_2PACK16_ARM,                      4,  0, 0, 0, 1) \
  X(R14X2G14X2B14X2A14X2_UINT_4PACK16_ARM,            8,  0, 0, 0, 1) \
  X(R14X2_UNORM_PACK16_ARM,                           2,  0, 0, 0, 0) \
  X(R14X2G14X2_UNORM_2PACK16_ARM,                     4,  0, 0, 0, 0) \
  X(R14X2G14X2B14X2A14X2_UNORM_4PACK16_ARM,           8,  0, 0, 0, 0) \
  X(G14X2_B14X2R14X2_2PLANE_420_UNORM_3PACK16_ARM,    0,  0, 0, 0, 0) \
  X(G14X2_B14X2R14X2_2PLANE_422_UNORM_3PACK16_ARM,    0,  0, 0, 0, 0) \
  X(R8_BOOL_ARM,                                      1,  0, 0, 0, 0)

typedef enum
{
  HINA_FORMAT_UNDEFINED = 0,
#define HINA_X_ENUM_(name, ...) HINA_FORMAT_##name,
  HINA_FORMAT_TABLE(HINA_X_ENUM_)
#undef HINA_X_ENUM_
  HINA_FORMAT_COUNT,  /* = 265 (including UNDEFINED) */
...
{
  uint16_t queue; // Logical queue (HINA_QUEUE_GRAPHICS/COMPUTE/TRANSFER)
...
// stage_flags must resolve to a single HINA_PIPELINE_STAGE_* bit.
